...
const coursesData = [
  {
    ...
    overlayImage: "https://c.animaapp.com/ml0tlc5743oHtU/img/rectangle-33.png",
    title: "AWS Certified solutions Architect",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipising elit, sed do eiusmod tempor",
    instructor: {
      name: "Lina",
      avatar: "https://c.animaapp.com/ml0tlc5743oHtU/img/image-12.png",
    },
    category: "Design",
    duration: "3 Month",
    originalPrice: "$100",
  ...
  },
  {
    ...
    instructor: {
      name: "Lina",
      avatar: "https://c.animaapp.com/ml0tlc5743oHtU/img/image-12-1.png",
    },
    category: "Design",
    duration: "3 Month",
    originalPrice: "$100",
  ...
  },
  {
    ...
    overlayImage:
      "https://c.animaapp.com/ml0tlc5743oHtU/img/rectangle-32-8.png",
    title: "AWS Certified solutions Architect",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipising elit, sed do eiusmod tempor",
    instructor: {
      name: "Lina",
      avatar: "https://c.animaapp.com/ml0tlc5743oHtU/img/image-12-2.png",
    },
    category: "Design",
    duration: "3 Month",
    originalPrice: "$100",
  ...
  },
  {
    ...
    instructor: {
      name: "Lina",
      avatar: "https://c.animaapp.com/ml0tlc5743oHtU/img/image-12-3.png",
    },
    category: "Design",
    duration: "3 Month",
    originalPrice: "$100",
...
export const FeaturedCoursesSection = (): JSX.Element => {
  return (
    <section className="w-full py-16 bg-[url(https://c.animaapp.com/ml0tlc5743oHtU/img/rectangle.svg)] bg-cover bg-center">
