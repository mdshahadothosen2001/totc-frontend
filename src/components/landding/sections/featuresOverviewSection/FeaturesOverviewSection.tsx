...
import { Card, CardContent } from "../../../../components/ui/Card" // "../../../../components/ui/card";
    ...
    <section className="w-full py-20 px-4 md:px-8 lg:px-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="relative p-8 min-h-[450px]">
                    ...
                    <div className="absolute top-[381px] left-[45px] flex gap-4">
                      <Button className="w-[155px] h-[51px] bg-[#3364e1] rounded-[51.07px] shadow-[0px_8.51px_20.43px_#3465e14c] hover:bg-[#2854d0] h-auto">
                        <span className="text-[22.1px] [font-family:'Nunito_Sans',Helvetica] font-bold text-white tracking-[0] leading-[normal]">
                          Present
                        </span>
                      </Button>

                      <Button className="relative w-[171px] h-[65px] bg-transparent hover:bg-transparent p-0 h-auto">
              ...
              <Card className="relative bg-white rounded-[20px] shadow-[0px_10px_48px_#272a6e1a] border-0">
                <CardContent className="p-0">
                  ...
                  <div className="relative p-8 min-h-[400px]">
                    ...
                    <Button className="absolute top-[456px] left-[554px] w-[172px] h-[59px] rounded-[60px] bg-[linear-gradient(157deg,rgba(84,90,231,1)_0%,rgba(57,63,207,1)_100%)] hover:opacity-90 h-auto">
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="relative p-8 min-h-[340px]">
                      ...
                      <div className="absolute top-[296px] left-9 flex gap-4">
                        <Button className="w-[118px] h-[39px] bg-[#3364e1] rounded-[38.67px] shadow-[0px_6.45px_15.47px_#3465e14c] hover:bg-[#2854d0] h-auto">
                          <span className="text-[16.8px] [font-family:'Nunito_Sans',Helvetica] font-bold text-white tracking-[0] leading-[normal]">
                            Present
                          </span>
                        </Button>

                        <Button className="relative w-[118px] h-[39px] bg-[#e13367] rounded-[38.67px] shadow-[0px_6.45px_15.47px_#c92e5d4c] hover:bg-[#d02257] h-auto">
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="relative p-8">
                      ...
                      <div className="mt-8">
                        ...
                        <Button className="w-[200px] h-[55px] rounded-[56.49px] bg-[linear-gradient(157deg,rgba(245,84,84,1)_0%,rgba(229,66,43,1)_100%)] hover:opacity-90 h-auto">
        ...
        <div className="flex justify-center mt-20 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:1200ms]">
          <Button
            variant="outline"
            className="w-[282px] h-20 rounded-[80px] border border-solid border-[#49bbbd] bg-transparent hover:bg-[#49bbbd]/10 h-auto"
          >
